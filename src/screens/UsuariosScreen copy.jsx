...
export default function UsuariosScreenReserva() {
  return (
      ...
      <ScrollView>
        <View style={styles.innerContainer}>
          ...
          <View style={styles2.container}>
            <TouchableOpacity
              style2={styles2.button}
              onPress={() => handleButtonPress("Adicionar")}
            >
              <Text style={styles2.buttonText}>Adicionar</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style2={styles2.button}
              onPress={() => handleButtonPress("Editar")}
            >
              <Text style={styles2.buttonText}>Editar</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style2={styles2.button}
              onPress={() => handleButtonPress("Remover")}
            >
              <Text style={styles2.buttonText}>Remover</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style2={styles2.button}
              onPress={() => handleButtonPress("Relatório")}
            >
